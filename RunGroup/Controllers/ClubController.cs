...
namespace RunGroup.Controllers
{
    public class ClubController : Controller
    {
        ...
        {
            var club = await this.clubRepository.GetByIdAsync(id);
            if (club == null)
                return View("Error");
        ...
        public async Task<IActionResult> Edit(int id, EditClubViewModel clubVM)
        {
            ...
            var userClub = await this.clubRepository.GetByIdAsyncNoTracking(id);
            ...
            if (userClub != null)
            {
                ...
                var photoResult = await this.photoService.AddPhotoAsync(clubVM.Image);
                var club = new Club
                {
                    Id = id,
                    Title = clubVM.Title,
